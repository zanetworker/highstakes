...
import (
	...
	"github.com/zanetworker/code-heatmap/internal/dashboard"
	"github.com/zanetworker/code-heatmap/internal/incidents"
	"github.com/zanetworker/code-heatmap/internal/prscore"
	"github.com/zanetworker/code-heatmap/internal/scorer"
	"github.com/zanetworker/code-heatmap/internal/tui"
...
var rootCmd = &cobra.Command{
	Use:           "heatmap",
	Short:         "Identify critical code paths for review",
	SilenceErrors: true,
	SilenceUsage:  true,
	Version:       version,
...
var initCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Fprintln(os.Stderr, "Next: run 'heatmap analyze'")
		return nil
	},
}
...
var incidentCreateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Fprintln(os.Stderr, "Run 'heatmap analyze' to update scores.")
		return nil
	},
}
...
jobs:
  triage:
    ...
    steps:
      ...
      - name: Analyze
        run: heatmap init && heatmap analyze --json
        env:
...
func loadHeatmap() (*types.Heatmap, error) {
	...
	if err != nil {
		return nil, cliError(4, "no heatmap found. Run: heatmap init && heatmap analyze")
	}
	return hm, nil
}
